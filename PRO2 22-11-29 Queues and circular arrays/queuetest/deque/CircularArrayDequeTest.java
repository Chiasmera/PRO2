...
class CircularArrayDequeTest {
    ...
    @BeforeEach
    void setUp() {
        this.deque = new CircularArrayDeque(10);
    ...
    void getFirst() {
        ...
        //Act
        Object output = deque.getFirst();

        //Assert
        assertEquals(salg6, output);
    ...
    void getLast() {
        ...
        //Act
        Object output = deque.getLast();

        //Assert
        assertEquals(salg1, output);
